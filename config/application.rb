...
module Ledger
  class Application < Rails::Application
    ...
    config.paperclip_defaults = {
      ...
      :s3_host_name => '',
      :s3_credentials => {
        :access_key_id => ENV['ledger_aws_access_key_id'],
        :secret_access_key => ENV['ledger_aws_secret_access_key'],
        :s3_region => ENV['ledger_aws_region']
      },
      :bucket => ENV['ledger_aws_bucket']
    }
